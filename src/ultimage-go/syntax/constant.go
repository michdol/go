...
func main() {
	// Constants can by typed or untyped.
	// They are converted by the compiler

	// Untyped constants
	const ui = 12345		// int
	const uf = 3.141592	// float

	// Typed constants still use the constant type system byt their precision is restriced.
	const ti int = 12345					// int
	const tf float64 = 3.141592 	// float

	// This won't work because 1000 overflows uint8
	// const customUint8 uint8 = 1000

	// This will be a float due to kind promotion
	const third = 1 / 3.0 	// KindFloat(1) / KindFloat(3.0)
	// This will be an integer
	const zero = 1 / 3 	// KindInt(1) / KingInt(3)
	fmt.Println(zero)

	// Arithmetic between typed and untyped constants
	const one int8 = 1
